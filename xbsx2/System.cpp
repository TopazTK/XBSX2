...
Xbsx2Config EmuConfig;


// This function should be called once during program execution.
void SysLogMachineCaps()
{
	Console.WriteLn(Color_StrongGreen, "XBSX2 %u.%u-%lld", XBSX2_VersionHi, XBSX2_VersionMid, GIT_HASH);
...
#if defined(_WIN32) && !defined(XBSX2_CORE)
...
// --------------------------------------------------------------------------------------
// Helper for initializing various XBSX2 CPU providers, and handing errors and cleanup.
//
template< typename CpuType >
...
static VirtualMemoryManagerPtr makeMainMemoryManager() {
	...
	// We'll hope that the code generated for the XBSX2 executable stays under 512mb (which is likely)
...
bool SysCpuProviderPack::HadSomeFailures( const Xbsx2Config::RecompilerOptions& recOpts ) const
{
