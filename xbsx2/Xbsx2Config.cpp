...
void Xbsx2Config::SpeedhackOptions::Set(SpeedhackId id, bool enabled)
{
...
Xbsx2Config::SpeedhackOptions::SpeedhackOptions()
{
	DisableAll();
...
Xbsx2Config::SpeedhackOptions& Xbsx2Config::SpeedhackOptions::DisableAll()
{
	bitset = 0;
	EECycleRate = 0;
	EECycleSkip = 0;
...
void Xbsx2Config::SpeedhackOptions::LoadSave(SettingsWrapper& wrap)
{
...
void Xbsx2Config::ProfilerOptions::LoadSave(SettingsWrapper& wrap)
{
...
Xbsx2Config::RecompilerOptions::RecompilerOptions()
{
	bitset = 0;
...
void Xbsx2Config::RecompilerOptions::ApplySanityCheck()
{
...
void Xbsx2Config::RecompilerOptions::LoadSave(SettingsWrapper& wrap)
{
...
bool Xbsx2Config::CpuOptions::CpusChanged(const CpuOptions& right) const
{
...
Xbsx2Config::CpuOptions::CpuOptions()
{
...
void Xbsx2Config::CpuOptions::ApplySanityCheck()
{
...
void Xbsx2Config::CpuOptions::LoadSave(SettingsWrapper& wrap)
{
...
const char* Xbsx2Config::GSOptions::AspectRatioNames[] = {
	"Stretch",
	"Auto 4:3/3:2",
	"4:3",
	"16:9",
...
const char* Xbsx2Config::GSOptions::FMVAspectRatioSwitchNames[] = {
	"Off",
	"Auto 4:3/3:2",
	"4:3",
	"16:9",
...
const char* Xbsx2Config::GSOptions::GetRendererName(GSRendererType type)
{
	switch (type)
	{
...
Xbsx2Config::GSOptions::GSOptions()
{
	bitset = 0;
...
bool Xbsx2Config::GSOptions::operator==(const GSOptions& right) const
{
	return (
...
bool Xbsx2Config::GSOptions::OptionsAreEqual(const GSOptions& right) const
{
	return (
		OpEqu(bitset) &&
...
bool Xbsx2Config::GSOptions::RestartOptionsAreEqual(const GSOptions& right) const
{
...
void Xbsx2Config::GSOptions::LoadSave(SettingsWrapper& wrap)
{
...
#ifdef XBSX2_CORE
void Xbsx2Config::GSOptions::LoadSaveIniSettings(SettingsWrapper& wrap)
{
	SettingsWrapSection("EmuCore/GS");
...
#else
void Xbsx2Config::GSOptions::ReloadIniSettings()
{
...
void Xbsx2Config::GSOptions::MaskUserHacks()
{
	if (ManualUserHacks)
		return;
...
void Xbsx2Config::GSOptions::MaskUpscalingHacks()
{
...
bool Xbsx2Config::GSOptions::UseHardwareRenderer() const
{
	return (Renderer != GSRendererType::Null && Renderer != GSRendererType::SW);
}

VsyncMode Xbsx2Config::GetEffectiveVsyncMode() const
{
...
const char* Xbsx2Config::DEV9Options::NetApiNames[] = {
	"Unset",
	"PCAP Bridged",
	"PCAP Switched",
	"TAP",
...
const char* Xbsx2Config::DEV9Options::DnsModeNames[] = {
	"Manual",
	"Auto",
	"Internal",
	nullptr};

Xbsx2Config::DEV9Options::DEV9Options()
{
	HddFile = "DEV9hdd.raw";
}

void Xbsx2Config::DEV9Options::LoadSave(SettingsWrapper& wrap)
{
	{
...
void Xbsx2Config::DEV9Options::LoadIPHelper(u8* field, const std::string& setting)
{
...
std::string Xbsx2Config::DEV9Options::SaveIPHelper(u8* field)
{
...
Xbsx2Config::GamefixOptions::GamefixOptions()
{
	DisableAll();
}

Xbsx2Config::GamefixOptions& Xbsx2Config::GamefixOptions::DisableAll()
{
	bitset = 0;
	return *this;
}

void Xbsx2Config::GamefixOptions::Set(GamefixId id, bool enabled)
{
	pxAssert(EnumIsValid(id));
	switch (id)
	{
...
bool Xbsx2Config::GamefixOptions::Get(GamefixId id) const
{
	pxAssert(EnumIsValid(id));
	switch (id)
	{
...
void Xbsx2Config::GamefixOptions::LoadSave(SettingsWrapper& wrap)
{
...
Xbsx2Config::DebugOptions::DebugOptions()
{
...
void Xbsx2Config::DebugOptions::LoadSave(SettingsWrapper& wrap)
{
...
Xbsx2Config::FilenameOptions::FilenameOptions()
{
}

void Xbsx2Config::FilenameOptions::LoadSave(SettingsWrapper& wrap)
{
...
void Xbsx2Config::FramerateOptions::SanityCheck()
{
...
void Xbsx2Config::FramerateOptions::LoadSave(SettingsWrapper& wrap)
{
...
void Xbsx2Config::LoadSave(SettingsWrapper& wrap)
{
...
void Xbsx2Config::LoadSaveMemcards(SettingsWrapper& wrap)
{
...
bool Xbsx2Config::MultitapEnabled(uint port) const
{
	pxAssert(port < 2);
	return (port == 0) ? MultitapPort0_Enabled : MultitapPort1_Enabled;
}

std::string Xbsx2Config::FullpathToBios() const
{
	std::string ret;
...
std::string Xbsx2Config::FullpathToMcd(uint slot) const
{
	return Path::Combine(EmuFolders::MemoryCards, Mcd[slot].Filename);
}

bool Xbsx2Config::operator==(const Xbsx2Config& right) const
{
	bool equal =
		OpEqu(bitset) &&
		OpEqu(Cpu) &&
...
void Xbsx2Config::CopyConfig(const Xbsx2Config& cfg)
{
	Cpu = cfg.Cpu;
	GS = cfg.GS;
	DEV9 = cfg.DEV9;
...
void EmuFolders::SetDefaults(SettingsInterface& si)
{
	...
	si.SetStringValue("Folders", "GameSettings", "gamesettings");
