...
s32 PADfreeze(FreezeAction mode, freezeData* data)
{
	...
	else if (mode == FreezeAction::Save)
	{
		...
		// Tales of the Abyss - pad fix
		// - XBSX2 only saves port0 (save #1), then port1 (save #2)
...
void PAD::SetDefaultControllerConfig(SettingsInterface& si)
{
	...
	// XBSX2 Controller Settings - Default pad types and parameters.
	for (u32 i = 0; i < NUM_CONTROLLER_PORTS; i++)
	{
	...
	// XBSX2 Controller Settings - Controller 1 / Controller 2 / ...
...
void PAD::SetDefaultHotkeyConfig(SettingsInterface& si)
{
	...
	// XBSX2 Controller Settings - Hotkeys

	// XBSX2 Controller Settings - Hotkeys - General
	si.SetStringValue("Hotkeys", "OpenPauseMenu", "XInput-0/Back & XInput-0/Start");

	// XBSX2 Controller Settings - Hotkeys - Graphics
	...
	// XBSX2 Controller Settings - Hotkeys - Input Recording
	//si.SetStringValue("Hotkeys", "InputRecToggleMode", "Keyboard/Shift & Keyboard/R");

	// XBSX2 Controller Settings - Hotkeys - Save States
	...
	// XBSX2 Controller Settings - Hotkeys - System
